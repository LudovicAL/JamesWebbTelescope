...
function generate_pyramid_IFS(){
    ...
    model.normals = [
        //Face 0
        (model.vertices[model.faces[0 * 3 + 0] * 3 + 0] + model.vertices[model.faces[0 * 3 + 1] * 3 + 0] + model.vertices[model.faces[0 * 3 + 2] * 3 + 0]) / 3,
        (model.vertices[model.faces[0 * 3 + 0] * 3 + 1] + model.vertices[model.faces[0 * 3 + 1] * 3 + 1] + model.vertices[model.faces[0 * 3 + 2] * 3 + 1]) / 3,
        (model.vertices[model.faces[0 * 3 + 0] * 3 + 2] + model.vertices[model.faces[0 * 3 + 1] * 3 + 2] + model.vertices[model.faces[0 * 3 + 2] * 3 + 2]) / 3,
        //Face 1
        (model.vertices[model.faces[1 * 3 + 0] * 3 + 0] + model.vertices[model.faces[1 * 3 + 1] * 3 + 0] + model.vertices[model.faces[1 * 3 + 2] * 3 + 0]) / 3,
        (model.vertices[model.faces[1 * 3 + 0] * 3 + 1] + model.vertices[model.faces[1 * 3 + 1] * 3 + 1] + model.vertices[model.faces[1 * 3 + 2] * 3 + 1]) / 3,
        (model.vertices[model.faces[1 * 3 + 0] * 3 + 2] + model.vertices[model.faces[1 * 3 + 1] * 3 + 2] + model.vertices[model.faces[1 * 3 + 2] * 3 + 2]) / 3,
        //Face 2
        (model.vertices[model.faces[2 * 3 + 0] * 3 + 0] + model.vertices[model.faces[2 * 3 + 1] * 3 + 0] + model.vertices[model.faces[2 * 3 + 2] * 3 + 0]) / 3,
        (model.vertices[model.faces[2 * 3 + 0] * 3 + 1] + model.vertices[model.faces[2 * 3 + 1] * 3 + 1] + model.vertices[model.faces[2 * 3 + 2] * 3 + 1]) / 3,
        (model.vertices[model.faces[2 * 3 + 0] * 3 + 2] + model.vertices[model.faces[2 * 3 + 1] * 3 + 2] + model.vertices[model.faces[2 * 3 + 2] * 3 + 2]) / 3,
        //Face 3
        (model.vertices[model.faces[3 * 3 + 0] * 3 + 0] + model.vertices[model.faces[3 * 3 + 1] * 3 + 0] + model.vertices[model.faces[3 * 3 + 2] * 3 + 0]) / 3,
        (model.vertices[model.faces[3 * 3 + 0] * 3 + 1] + model.vertices[model.faces[3 * 3 + 1] * 3 + 1] + model.vertices[model.faces[3 * 3 + 2] * 3 + 1]) / 3,
        (model.vertices[model.faces[3 * 3 + 0] * 3 + 2] + model.vertices[model.faces[3 * 3 + 1] * 3 + 2] + model.vertices[model.faces[3 * 3 + 2] * 3 + 2]) / 3,
    ];
    return model
}
...
function draw_earth(model, rotation, scale) {
    ...
    glPopMatrix();
    glMatrixMode(GL_MODELVIEW); // Leave matrix mode set to GL MODELVIEW.
    glScalef(scale, scale, scale);
